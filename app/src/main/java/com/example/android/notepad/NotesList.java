...
//END_INCLUDE(copy)
    ...
    public void setColor()
    {
        ...
        background=preferences.getString("color", "");
        if(background.equals("")){
            ...
            switch (background)
            {
                case "#FFFFFF":
                    ...
                    break;
                case "#FFFF00":
                    getListView().setBackgroundResource(R.drawable.dusk);
                    break;
                case "#FFA500":
                    getListView().setBackgroundResource(R.drawable.orange);
                    break;
                case "#FFC0CB":
                    getListView().setBackgroundResource(R.drawable.pink);
                    break;
                case "#DDA0DD":
                    getListView().setBackgroundResource(R.drawable.purple);
                    break;
                case "#87CEFA":
                    getListView().setBackgroundResource(R.drawable.ocean);
                    break;
                case "#FFF8DC":
                    getListView().setBackgroundResource(R.drawable.mise);
                    break;
                case "#90EE90":
                    getListView().setBackgroundResource(R.drawable.green);
                    break;
                default:
                    getListView().setBackgroundColor(Color.parseColor("#F5F5F5"));
                    break;
