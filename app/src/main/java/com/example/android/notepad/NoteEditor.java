...
public class NoteEditor extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backgroundColor=sharedPreferences.getString("color", "");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case R.id.menu_revert:
            ...
            case R.id.menu_color:
                LayoutInflater inflater=LayoutInflater.from(this);
                View changeColor=inflater.inflate(R.layout.note_change_color, null);
                final AlertDialog.Builder builder=new AlertDialog.Builder (this).setView(changeColor);
                final Dialog dialog=builder.show();
                textView1=(TextView)changeColor.findViewById(R.id.text_color1);
                ...
                textView2=(TextView)changeColor.findViewById(R.id.text_color2);
                ...
                textView3=(TextView)changeColor.findViewById(R.id.text_color3);
                ...
                textView4=(TextView)changeColor.findViewById(R.id.text_color4);
                ...
                textView5=(TextView)changeColor.findViewById(R.id.text_color5);
                ...
                textView6=(TextView)changeColor.findViewById(R.id.text_color6);
                textView6.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        view.setBackgroundColor(Color.parseColor("#DDA0DD"));
                        saveColor("#DDA0DD");
                        dialog.dismiss();
                    }
                });
                textView7=(TextView)changeColor.findViewById(R.id.text_color7);
                ...
                textView8=(TextView)changeColor.findViewById(R.id.text_color8);
